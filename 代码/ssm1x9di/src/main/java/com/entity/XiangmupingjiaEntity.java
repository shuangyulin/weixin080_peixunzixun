 ...
 */
@TableName("xiangmupingjia")
public class XiangmupingjiaEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public XiangmupingjiaEntity() {
		
	}
	
	public XiangmupingjiaEntity(T t) {
		try {
	...
	private String zixunshipingjia;
	 ...
	 * 设置：咨询师评价
	 */
	public void setZixunshipingjia(String zixunshipingjia) {
		this.zixunshipingjia = zixunshipingjia;
	}
	/**
	 * 获取：咨询师评价
	 */
	public String getZixunshipingjia() {
		return zixunshipingjia;
	}
	/**
	 * 设置：满意度
	 */
