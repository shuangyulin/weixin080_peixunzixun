...
public class KechengpingjiaEntity<T> implements Serializable {
	 ...
	 * 设置：课程评价
	 */
	public void setKechengpingjia(String kechengpingjia) {
		this.kechengpingjia = kechengpingjia;
	}
	/**
	 * 获取：课程评价
	 */
	public String getKechengpingjia() {
		return kechengpingjia;
	}
	/**
	 * 设置：老师评价
	 */
