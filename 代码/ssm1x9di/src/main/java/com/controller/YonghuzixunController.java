...
public class YonghuzixunController {
    ...
    public R page(@RequestParam Map<String, Object> params,YonghuzixunEntity yonghuzixun, 
		...
		if(tableName.equals("shangjia")) {
			yonghuzixun.setShangjiazhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("yonghu")) {
			yonghuzixun.setZhanghao((String)request.getSession().getAttribute("username"));
		}
