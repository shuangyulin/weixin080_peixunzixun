	...
	<view class="content">
		<form class="app-update-pv">
				...
				<input :style='{"boxShadow":"0 0 4rpx rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(0,0,0,.6)","borderRadius":"16rpx","color":"rgba(23, 152, 242, 1)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"110rpx"}' :disabled="ro.dingdanbianhao" v-model="ruleForm.dingdanbianhao" placeholder="订单编号"></input>
												...
												<view :style='{"boxShadow":"0 0 16rpx rgba(0,0,0,.3)","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"#ccc","margin":"0 0 20rpx 0","borderWidth":"0","borderStyle":"solid","height":"108rpx"}' class="cu-form-group">
				<view :style='{"width":"170rpx","fontSize":"28rpx","color":"rgba(0, 0, 0, 1)","textAlign":"left"}' class="title">项目名称</view>
				<input :style='{"boxShadow":"0 0 4rpx rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(0,0,0,.6)","borderRadius":"16rpx","color":"rgba(23, 152, 242, 1)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"110rpx"}' :disabled="ro.xiangmumingcheng" v-model="ruleForm.xiangmumingcheng" placeholder="项目名称"></input>
			</view>
				...
				<view :style='{"width":"170rpx","fontSize":"28rpx","color":"rgba(0, 0, 0, 1)","textAlign":"left"}' class="title">项目评价</view>
				<picker @change="xiangmupingjiaChange" :value="xiangmupingjiaIndex" :range="xiangmupingjiaOptions">
					<view :style='{"boxShadow":"0 0 4rpx rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(0,0,0,.6)","borderRadius":"16rpx","color":"rgba(23, 152, 242, 1)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' class="uni-input">{{ruleForm.xiangmupingjia?ruleForm.xiangmupingjia:"请选择项目评价"}}</view>
				</picker>
			</view>
												<view :style='{"boxShadow":"0 0 16rpx rgba(0,0,0,.3)","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"#ccc","margin":"0 0 20rpx 0","borderWidth":"0","borderStyle":"solid","height":"108rpx"}' class="cu-form-group select">
				<view :style='{"width":"170rpx","fontSize":"28rpx","color":"rgba(0, 0, 0, 1)","textAlign":"left"}' class="title">咨询师评价</view>
				<picker @change="zixunshipingjiaChange" :value="zixunshipingjiaIndex" :range="zixunshipingjiaOptions">
					<view :style='{"boxShadow":"0 0 4rpx rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(0,0,0,.6)","borderRadius":"16rpx","color":"rgba(23, 152, 242, 1)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' class="uni-input">{{ruleForm.zixunshipingjia?ruleForm.zixunshipingjia:"请选择咨询师评价"}}</view>
				</picker>
			</view>
												<view :style='{"boxShadow":"0 0 16rpx rgba(0,0,0,.3)","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"#ccc","margin":"0 0 20rpx 0","borderWidth":"0","borderStyle":"solid","height":"108rpx"}' class="cu-form-group select">
				<view :style='{"width":"170rpx","fontSize":"28rpx","color":"rgba(0, 0, 0, 1)","textAlign":"left"}' class="title">满意度</view>
				<picker @change="manyiduChange" :value="manyiduIndex" :range="manyiduOptions">
					<view :style='{"boxShadow":"0 0 4rpx rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(0,0,0,.6)","borderRadius":"16rpx","color":"rgba(23, 152, 242, 1)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' class="uni-input">{{ruleForm.manyidu?ruleForm.manyidu:"请选择满意度"}}</view>
				</picker>
			</view>
																					<view :style='{"boxShadow":"0 0 16rpx rgba(0,0,0,.3)","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"#ccc","margin":"0 0 20rpx 0","borderWidth":"0","borderStyle":"solid","height":"108rpx"}' class="cu-form-group">
				<view :style='{"width":"170rpx","fontSize":"28rpx","color":"rgba(0, 0, 0, 1)","textAlign":"left"}' class="title">评价时间</view>
				<input :style='{"boxShadow":"0 0 4rpx rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(0,0,0,.6)","borderRadius":"16rpx","color":"rgba(23, 152, 242, 1)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"110rpx"}' v-model="ruleForm.pingjiashijian" placeholder="评价时间" @tap="toggleTab('pingjiashijian')"></input>
			</view>
												<view :style='{"boxShadow":"0 0 16rpx rgba(0,0,0,.3)","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"#ccc","margin":"0 0 20rpx 0","borderWidth":"0","borderStyle":"solid","height":"108rpx"}' class="cu-form-group">
			...
			<!-- 否 -->
				...
				<view :style='{"width":"170rpx","fontSize":"28rpx","color":"rgba(0, 0, 0, 1)","textAlign":"left"}' class="title">评语</view>
				<textarea :style='{"boxShadow":"0 0 4rpx rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(0,0,0,.6)","borderRadius":"16rpx","color":"rgba(23, 152, 242, 1)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"280rpx"}' v-model="ruleForm.pingyu" placeholder="评语"></textarea>
			</view>
			...
			<view class="btn">
				<button :style='{"boxShadow":"0 0 16rpx rgba(0,0,0,0) inset","backgroundColor":"#409EFF","borderColor":"#409EFF","borderRadius":"8rpx","color":"#fff","borderWidth":"2rpx","width":"160rpx","fontSize":"28rpx","borderStyle":"solid","height":"80rpx"}' @tap="onSubmitTap" class="bg-red">提交</button>
																																		...
																																		<w-picker mode="dateTime" step="1" :current="false" :hasSecond="false" @confirm="pingjiashijianConfirm" ref="pingjiashijian" themeColor="#333333"></w-picker>
...
<script>
	...
	export default {
				...
				ruleForm: {
												dingdanbianhao: '',
																...
																userid: '',
																																				...
																																				xiangmupingjiaOptions: [],
				xiangmupingjiaIndex: 0,
																zixunshipingjiaOptions: [],
				zixunshipingjiaIndex: 0,
																manyiduOptions: [],
				manyiduIndex: 0,
																																																																				// 登陆用户信息
				user: {},
                                ro:{
                                   ...
                                   fengmian : false,
                                   xiangmupingjia : false,
                                   zixunshipingjia : false,
                                   manyidu : false,
                                   pingyu : false,
		...
		async onLoad(options) {
        		this.ruleForm.pingjiashijian = this.$utils.getCurDateTime();
			...
			this.user = res.data;
						...
						// ss读取
												...
												this.ruleForm.xingming = this.user.xingming
																														...
																														// 自定义下拉框值
			this.xiangmupingjiaOptions = "★,★★,★★★,★★★★,★★★★★".split(',')
												// 自定义下拉框值
			this.zixunshipingjiaOptions = "★,★★,★★★,★★★★,★★★★★".split(',')
												// 自定义下拉框值
			this.manyiduOptions = "满意,一般,不满意".split(',')
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`xiangmupingjia`, this.ruleForm.id);
			...
			if(options.cross){
				...
				for (var o in obj){
					...
					if(o=='xiangmupingjia'){
					this.ruleForm.xiangmupingjia = obj[o];
					this.ro.xiangmupingjia = true;
					continue;
					}
					if(o=='zixunshipingjia'){
					this.ruleForm.zixunshipingjia = obj[o];
					this.ro.zixunshipingjia = true;
					continue;
					}
					if(o=='manyidu'){
		...
		methods: {
			...
			// 多级联动参数
																																																			...
																																																			// 日长控件选择日期时间
			pingjiashijianConfirm(val) {
				console.log(val)
				this.ruleForm.pingjiashijian = val.result;
				this.$forceUpdate();
			},
																																				
																											// 下拉变化
			xiangmupingjiaChange(e) {
				this.xiangmupingjiaIndex = e.target.value
				this.ruleForm.xiangmupingjia = this.xiangmupingjiaOptions[this.xiangmupingjiaIndex]
			},
												// 下拉变化
			zixunshipingjiaChange(e) {
				this.zixunshipingjiaIndex = e.target.value
				this.ruleForm.zixunshipingjia = this.zixunshipingjiaOptions[this.zixunshipingjiaIndex]
			},
												// 下拉变化
			manyiduChange(e) {
				this.manyiduIndex = e.target.value
				this.ruleForm.manyidu = this.manyiduOptions[this.manyiduIndex]
			},
			...
			async onSubmitTap() {
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																if(this.ruleForm.id){
					await this.$api.update(`xiangmupingjia`, this.ruleForm);
				}else{
					await this.$api.add(`xiangmupingjia`, this.ruleForm);
				}
