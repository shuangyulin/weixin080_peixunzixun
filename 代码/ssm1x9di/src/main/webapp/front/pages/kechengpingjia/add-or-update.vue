	...
	<view class="content">
		<form class="app-update-pv">
				...
				<input :style='{"boxShadow":"0 0 4rpx rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(0,0,0,.6)","borderRadius":"16rpx","color":"rgba(23, 152, 242, 1)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"110rpx"}' :disabled="ro.dingdanbianhao" v-model="ruleForm.dingdanbianhao" placeholder="订单编号"></input>
												...
												<view :style='{"boxShadow":"0 0 16rpx rgba(0,0,0,.3)","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"#ccc","margin":"0 0 20rpx 0","borderWidth":"0","borderStyle":"solid","height":"108rpx"}' class="cu-form-group">
				<view :style='{"width":"170rpx","fontSize":"28rpx","color":"rgba(0, 0, 0, 1)","textAlign":"left"}' class="title">课程名称</view>
				<input :style='{"boxShadow":"0 0 4rpx rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(0,0,0,.6)","borderRadius":"16rpx","color":"rgba(23, 152, 242, 1)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"110rpx"}' :disabled="ro.kechengmingcheng" v-model="ruleForm.kechengmingcheng" placeholder="课程名称"></input>
			</view>
				...
				<view :style='{"width":"170rpx","fontSize":"28rpx","color":"rgba(0, 0, 0, 1)","textAlign":"left"}' class="title">课程评价</view>
				<picker @change="kechengpingjiaChange" :value="kechengpingjiaIndex" :range="kechengpingjiaOptions">
					<view :style='{"boxShadow":"0 0 4rpx rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(0,0,0,.6)","borderRadius":"16rpx","color":"rgba(23, 152, 242, 1)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' class="uni-input">{{ruleForm.kechengpingjia?ruleForm.kechengpingjia:"请选择课程评价"}}</view>
				</picker>
			</view>
												<view :style='{"boxShadow":"0 0 16rpx rgba(0,0,0,.3)","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"#ccc","margin":"0 0 20rpx 0","borderWidth":"0","borderStyle":"solid","height":"108rpx"}' class="cu-form-group select">
				<view :style='{"width":"170rpx","fontSize":"28rpx","color":"rgba(0, 0, 0, 1)","textAlign":"left"}' class="title">老师评价</view>
				<picker @change="laoshipingjiaChange" :value="laoshipingjiaIndex" :range="laoshipingjiaOptions">
					<view :style='{"boxShadow":"0 0 4rpx rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(0,0,0,.6)","borderRadius":"16rpx","color":"rgba(23, 152, 242, 1)","textAlign":"left","borderWidth":"2rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' class="uni-input">{{ruleForm.laoshipingjia?ruleForm.laoshipingjia:"请选择老师评价"}}</view>
				</picker>
			</view>
												<view :style='{"boxShadow":"0 0 16rpx rgba(0,0,0,.3)","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"#ccc","margin":"0 0 20rpx 0","borderWidth":"0","borderStyle":"solid","height":"108rpx"}' class="cu-form-group select">
	...
	export default {
				...
				ruleForm: {
												dingdanbianhao: '',
																...
																userid: '',
																																				...
																																				kechengpingjiaOptions: [],
				kechengpingjiaIndex: 0,
																laoshipingjiaOptions: [],
				laoshipingjiaIndex: 0,
																manyiduOptions: [],
				manyiduIndex: 0,
																																																																				// 登陆用户信息
				user: {},
		...
		async onLoad(options) {
			...
			this.user = res.data;
						...
						// ss读取
												...
												this.ruleForm.xingming = this.user.xingming
																														...
																														// 自定义下拉框值
			this.kechengpingjiaOptions = "★,★★,★★★,★★★★,★★★★★".split(',')
												// 自定义下拉框值
			this.laoshipingjiaOptions = "★,★★,★★★,★★★★,★★★★★".split(',')
												// 自定义下拉框值
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`kechengpingjia`, this.ruleForm.id);
			...
			if(options.cross){
				...
				for (var o in obj){
					...
					if(o=='kechengpingjia'){
					this.ruleForm.kechengpingjia = obj[o];
					this.ro.kechengpingjia = true;
					continue;
					}
					if(o=='laoshipingjia'){
					this.ruleForm.laoshipingjia = obj[o];
					this.ro.laoshipingjia = true;
					continue;
					}
					if(o=='manyidu'){
		...
		methods: {
			...
			pingjiashijianConfirm(val) {
				...
				this.$forceUpdate();
																											...
																											// 下拉变化
			kechengpingjiaChange(e) {
				this.kechengpingjiaIndex = e.target.value
				this.ruleForm.kechengpingjia = this.kechengpingjiaOptions[this.kechengpingjiaIndex]
			},
												// 下拉变化
			laoshipingjiaChange(e) {
				this.laoshipingjiaIndex = e.target.value
				this.ruleForm.laoshipingjia = this.laoshipingjiaOptions[this.laoshipingjiaIndex]
			},
												// 下拉变化
			manyiduChange(e) {
			...
			async onSubmitTap() {
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																if(this.ruleForm.id){
					await this.$api.update(`kechengpingjia`, this.ruleForm);
				}else{
					await this.$api.add(`kechengpingjia`, this.ruleForm);
				}
