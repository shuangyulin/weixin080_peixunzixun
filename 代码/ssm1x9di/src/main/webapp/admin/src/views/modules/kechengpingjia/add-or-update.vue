<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="课程评价" prop="kechengpingjia">
          <el-select v-model="ruleForm.kechengpingjia" placeholder="请选择课程评价">
            <el-option
                v-for="(item,index) in kechengpingjiaOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="课程评价" prop="kechengpingjia">
	      <el-input v-model="ruleForm.kechengpingjia"
                placeholder="课程评价" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="老师评价" prop="laoshipingjia">
          <el-select v-model="ruleForm.laoshipingjia" placeholder="请选择老师评价">
            <el-option
                v-for="(item,index) in laoshipingjiaOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="老师评价" prop="laoshipingjia">
	      <el-input v-model="ruleForm.laoshipingjia"
                placeholder="老师评价" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
